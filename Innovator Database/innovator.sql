...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2021 at 05:01 PM
...
(12, 'arun', 'itpm', '1000.00', 'good'),
(14, 'dush', 'it', '234', 'good'),
(15, 'ruchi', 'itp', '12000', 'good'),
(16, 'hirunika', 'paf', '20000', 'good');
...
--
ALTER TABLE `innovator`
  MODIFY `innovatorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
